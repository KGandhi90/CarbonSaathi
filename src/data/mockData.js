...
export const chatSeedMessages = [
  ...
  },
  {
    ...
    role: 'assistant',
    content:
      'For most urban Indians, transport is the biggest contributor — especially daily cab usage. Switching from Ola/Uber to metro can cut 60-80% of your transport emissions. 20km daily by cab = ~4.2 kg CO₂. Metro brings it to ~0.8 kg. That single change saves ~1,000 kg CO₂ per year. Want city-specific metro tips?',
    timestamp: '10:24 AM',
  },
];
